...
public class TremPorco extends Thread {
  ...
  /******************************************************************************
   * Metodo: TremPorco
   * Funcao: Construtor da classe TremPorco
   * Parametros: ImageView trem, Slider sliderTrem,int posInicialX, int
   * posInicialY, boolean vindoDeBaixo
   * Retorno: nenhum
   ******************************************************************************/
  public TremPorco(ImageView trem, Slider sliderTrem, int posInicialX, int posInicialY, boolean vindoDeBaixo) {
    this.trem = trem;
  ...
  public void vindoDeBaixoVariavelDeTravamento() {
    if (trem.getLayoutY() >= 650) {
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    }
    if (trem.getLayoutY() >= 593 && trem.getLayoutY() <= 650) {
      trem.setRotate(45);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    ...
    if (trem.getLayoutY() >= 570 && trem.getLayoutY() <= 591) {
      ...
      trem.setRotate(45);
      trem.setLayoutY(trem
          .getLayoutY() - sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
    }
    ...
    if (trem.getLayoutY() >= 390 && trem.getLayoutY() <= 473) {
      trem.setRotate(-45);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() - sliderTrem.getValue());
    }
    if (trem.getLayoutY() >= 305 && trem.getLayoutY() <= 390) {
      trem.setRotate(0);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    }
    ...
    if (trem.getLayoutY() >= 220 && trem.getLayoutY() <= 250) {
      Principal.variavelDeTravamento2 = 1;
      trem.setRotate(45);
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    }
    if (trem.getLayoutY() >= 135 && trem.getLayoutY() <= 220) {
      trem.setRotate(0);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    }
    ...
    if (trem.getLayoutY() >= 55 && trem.getLayoutY() <= 133) {
      trem.setRotate(-45);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() - sliderTrem.getValue());
    }
    if (trem.getLayoutY() > -40 && trem.getLayoutY() <= 55) {
      trem.setRotate(0);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    }
  ...
  public void vindoDeCimaVariavelDeTravamento() {
    ...
    // FIM DA ZONA CRITICA 2 --------------------------------------------------------------------------
    if (trem.getLayoutY() <= 312 && trem.getLayoutY() >= 226) {
      trem.setRotate(230);
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() - sliderTrem.getValue());
    }
    if (trem.getLayoutY() <= 399 && trem.getLayoutY() >= 312) {
      trem.setRotate(180);
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
    }
    if (trem.getLayoutY() <= 450 && trem.getLayoutY() >= 399) {
      trem.setRotate(135);
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
    }
    ...
    if (trem.getLayoutY() <= 484 && trem.getLayoutY() >= 452) {
      Principal.variavelDeTravamento1 = 1;
      trem.setRotate(135);
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
    }
    if (trem.getLayoutY() <= 569 && trem.getLayoutY() >= 484) {
      trem.setRotate(180);
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
    }
    if (trem.getLayoutY() <= 601 && trem.getLayoutY() >= 569) {
      Principal.variavelDeTravamento1 = 0;
      trem.setRotate(230);
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() - sliderTrem.getValue());
    ...
    // FIM DA ZONA CRITICA 1 ------------------------------------------------------------------------
    if (trem.getLayoutY() <= 650 && trem.getLayoutY() >= 601) {
      trem.setRotate(230);
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() - sliderTrem.getValue());
    }
  ...
  // __________________________ FIM DA VARIAVEL DE TRAVAMENTO_____________________________________________//




  // _______________________________ ESTRITA ALTERNANCIA__________________________________________________//
  ...
  public void vindoDeBaixoEstritaAlternancia() {
    ...
    // ZONA CRITICA 1 ----------------------------------------------------------------------------------
    if (trem.getLayoutY() >= 591 && trem.getLayoutY() <= 593 && Principal.vez1 == 0) {
      trem.setRotate(45);
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
    }
    ...
    // ZONA CRITICA 2 ----------------------------------------------------------------------------------
    if (trem.getLayoutY() >= 250 && trem.getLayoutY() <= 252 && Principal.vez2 == 0) {
      trem.setRotate(45);
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
      trem.setLayoutY(trem.getLayoutY() - sliderTrem.getValue());
    }
  ...
  public void vindoDeCimaEstritaAlternancia() {
    ...
    // ZONA CRITICA 2 ----------------------------------------------------------------------------------
    if (trem.getLayoutY() <= 114 && trem.getLayoutY() >= 112 && Principal.vez2 == 0) {
      trem.setRotate(135);
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
    }
    ...
    // ZONA CRITICA 1 ----------------------------------------------------------------------------------
    if (trem.getLayoutY() <= 452 && trem.getLayoutY() >= 450 && Principal.vez1 == 0) {
      trem.setRotate(135);
      trem.setLayoutX(trem.getLayoutX() + sliderTrem.getValue());
      trem.setLayoutY(trem.getLayoutY() + sliderTrem.getValue());
    }
  ...
  // __________________________ FIM DA ESTRITA ALTERNANCIA_____________________________________________//
  ...
  // _________________________________SOLUCAO DE PETERSON_____________________________________________//

  /************************************************************************
   * Metodo: vindoDeBaixoSolucaoDePeterson
   * Funcao: Movimenta o trem de baixo para cima utilizando a estrategia
   * da solucao de Peterson para controle de zona critica.
   * Parametros: nenhum
   * Retorno: nenhum
   *************************************************************************/
   ...
   * Funcao: Movimenta o trem de cima para baixo utilizando a estrategia
   * de Solucao de Peterson para controle de zona critica.
   * Parametros: nenhum
   * Retorno: nenhum
   *************************************************************************/
  ...
  // ____________________________FIM DA SOLUCAO DE PETERSON_____________________________________________//

  /****************************************************************
   * Metodo: pararTremPorco
   * Funcao: Para o movimento do trem do porco
   * Parametros: nenhum
   * Retorno: nenhum
   ****************************************************************/
  public void pararTremPorco() {
    if (emMovimento) {
      emMovimento = false;
    }
  }
  ...
  /*********************************************************************
   * Metodo: moverTremPorco
   * Funcao: Inicia o movimento do trem do porco
   * Parametros: nenhum
   * Retorno: nenhum
   ********************************************************************/
  public void moverTremPorco() {
    emMovimento = true;
  }

  /*****************************************************************************
   * Metodo: resetarTremPorco
   * Funcao: Reseta a posicao e orientacao do trem do porco
   * Parametros: boolean porBaixo - indica se o trem deve ser resetado por baixo
   * Retorno: nenhum
   *****************************************************************************/
  public void resetarTremPorco(boolean porBaixo) {
    pararTremPorco();
